package com.mrq.expandable.model;
...
import com.mrq.expandable.R;

import utils.CustomViewUtils;

/**
 * Created by Ibrahim Mrq on 29/07/2021.
 */
...
//    private ImageView mIndicatorImage;
    private TextView mIndicatorImage;
...
//        mIndicatorImage = (ImageView) mBaseLayout.findViewById(R.id.indicator_image);
        mIndicatorImage = (TextView) mBaseLayout.findViewById(R.id.indicator_image);
        ...
        relativeLayout = (RelativeLayout) mBaseLayout.findViewById(R.id.relativeLayout);
...
//        });
    ...
    public void setExpanded(boolean mSubItemsShowns) {
        mSubItemsShown = mSubItemsShowns;
    }
...
//    }
    public void setIndicatorIconRes(String iconRes) {
        setIndicatorText(iconRes);
    }
...
//    }
    public void setIndicatorText(String icon) {
        mIndicatorImage.setText(icon);
    }
